...
*/
	function success(){
		...
		*/							
		...
		//触发bi数据上报事件
		$(".m-page").filter('.show').trigger('success');			
	}
/*
** 声音功能
*/
...
function ajax_form_submit(form){
	...
	loading('loading');
	var host = $('body').data('form-host');
	$.ajax({
		url: host+'/car/submit/'+activeId,
		cache: false,
		dataType: 'html',
		async: false,
		type:'POST',
...
function ajax_custom_submit(form){
	...
	var host = $('body').data('form-host');
	$.ajax({
		url: host+'/realty/custom_submit/'+activity_id,
		cache: false,
		dataType: 'json',
		async: false,
		type:'POST',
...
function ajax_custom_submit(form){
	...
	var host = $('body').data('form-host');
	$.ajax({
		url: host+'/car/custom_submit/'+activeId,
		cache: false,
		dataType: 'json',
		async: false,
		type:'POST',
