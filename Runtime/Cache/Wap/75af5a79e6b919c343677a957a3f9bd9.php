...
<body onLoad="startExcute()">
	<div> 
		<section class="login_bt">
			<div class="divoi">
				<p>我们已发送验证码至您的邮箱，请在输入框内填写验证码，若未收到请耐心等候~</p>
			</div>
			
			<form id="form" action="?act=emailzc" method="post">
				<div class="divoi_odi">
					<div class="login_td" id="login_dt">
						<input type="number" name="qryzm" placeholder="请输入验证码" id="captcha" onKeyDown="return handleEnter(this, event)">
				...
				<div class="asied">
					<div class="aisde_odi">
						<input type="text" placeholder="请输入昵称" id="inviteCode" name="username" onKeyPress="if(event.keyCode==13){checkCaptcha();}">
					</div>
				</div>
			...
			<div class="odi"></div>
			<aside>
				<input type="submit" value="注册"  class="login_btn" name="register" id="regButton" onClick="return checkCaptcha()">
			</aside>	
		   </form>
		</section>
	</div>
