...
<body>
	<div class = "box">
		<section class = "xiugai">
			<form id="form" action="?act=setrz" method="post">

				
				
					<div class = "asied">
						<div class = "aisde_odi">
							<input type="text" placeholder="请输入您的真实姓名"  id = "val" name="relname" />
						</div>
					</div>
					<div class = "asied">
						<div class = "aisde_odi">
							<input type="text" placeholder="请输入您的身份证号"  id = "vlu" name="idcard" />
						</div>
					</div>
					<div class = "asied">
						<div class = "aisde_odi">
							<input type="text" placeholder="请输入您的qq号"  id = "vlu" name="qq" />
						</div>
					</div>
					<div class = "asied">
						<div class = "aisde_odi">
							<input type="text" placeholder="请输入您的生日号"  id = "vlu" name="birthday" />
						</div>
					</div>
					<div class = "asied">
						<div class = "aisde_odi">
							<input type="text" placeholder="请输入您的地址"  id = "vlu" name="site" />
						</div>
					</div>
